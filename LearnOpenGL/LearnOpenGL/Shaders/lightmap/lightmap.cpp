...
void LightMap::Draw(GLFWwindow * window)
{
    ...
    actor->SetTexture("Resource/Image/container2.png",0);
    ...
    lightObject->SetShader("Shaders/lightmap/lvs.strings","Shaders/lightmap/lfs.strings",true ,false, false);
